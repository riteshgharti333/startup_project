...
const Career: React.FC = () => {
  ...
  const benefits = [
    {
      ...
      description: "Continuous learning opportunities, workshops, and a ₹50,000 annual learning budget.",
    },
    {
      icon: <FiHeart size={20} />,
      title: "Health & Wellness",
      description: "Comprehensive health insurance for you and your family, plus mental wellness support.",
    },
    {
      icon: <FiClock size={20} />,
      title: "Flexible Hours",
      description: "Work when you're most productive with flexible timing and remote-first culture.",
    },
    {
  ...
  // Values data
  const values = [
    { title: "Excellence", description: "We strive for excellence in everything we deliver." },
    { title: "Ownership", description: "Take initiative and responsibility for outcomes." },
        ...
        <div className="relative max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-2 bg-(--surface) border border-(--border) rounded-(--radius-xl) mb-6">
              ...
              <span className="text-sm text-(--text-muted)">Join Our Team</span>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-(--text-muted) max-w-2xl mx-auto">
              We believe in creating an environment where you can thrive both personally
              and professionally.
            </p>
          </motion.div>
