...
const Terms: React.FC = () => {
  ...
  return (
    <>
      <PageSEO
        title="Terms & Conditions | Twipra Technology"
        description="Read Twipra Technology's Terms & Conditions governing the use of our web development, AI solutions, mobile app development, and digital marketing services."
        keywords={[
          "terms and conditions",
          "terms of service",
          "Twipra Technology terms",
          "service agreement",
          "legal terms",
          "website terms",
        ]}
        ...
        breadcrumbItems={[
          ...
          { name: "Terms & Conditions", url: `${baseUrl}/terms` },
        ]}
      />
          ...
          <div className="relative max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-(--text-muted) max-w-2xl mx-auto">
                Last updated: June 2024 · Please read these terms carefully
