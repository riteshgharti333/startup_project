...
const Navbar: React.FC = () => {
  ...
  <div className="flex items-center gap-2 ml-auto">
    ...
    <motion.a
      ...
      whileHover={{ scale: 1.02 }}
      whileTap={{ scale: 0.98 }}
      className="flex items-center gap-1.5 p-3 bg-(--primary) text-white text-xs font-medium rounded-(--radius-xl) hover:bg-(--primary-hover) transition-colors shadow-lg h-[45px]"
    >
      <FiPhone size={14} />
